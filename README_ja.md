...
同梱されている Chrome 拡張機能は、メディアの URL をすばやく取得して配信するための主要な方法です。Chrome ウェブストアには公開されていないため、ローカルで読み込む必要があります。
...
5. このプロジェクトディレクトリ内にある `chrome-extension/extension` フォルダを選択します。
